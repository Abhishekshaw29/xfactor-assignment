...
class Studentdetail{
    ...
    String gender;
    String address;
    Studentdetail(String name, int age, String gender, String address)
    {
        this.name = name;
        this.age = age;
        this.gender = gender;
...
class Departments{
    String name;
    String HOD;
    Departments(String name, String HOD)
    {
        this.name = name;
        this.HOD = HOD;
    }
...
class Main{
    ...
    {
        ArrayList<Departments> dept_list = new ArrayList<Department>();
        ArrayList<Studentdetail> student_list = new ArrayList<Student>();
